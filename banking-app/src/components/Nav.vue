<template>
<div>
    <div class="h-12 bg-gradient-to-b from-transparent to-indigo-100"></div>
    ...
    <nav class="p-4 flex items-center justify-between text-gray-700">
        ...
        <button class="py-1 px-2 text-white bg-indigo-800 rounded-lg">
        <!-- plus -->
        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
        </button>
        <button>
        <!-- currency -->
        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 11V9a2 2 0 00-2-2m2 4v4a2 2 0 104 0v-1m-4-3H9m2 0h4m6 1a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
        </button>
        <button>
        <!-- user -->
